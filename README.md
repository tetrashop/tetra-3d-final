...
```bash
git clone https://github.com/tetrashop/tetra-3d-final.git
cd tetra-3d-final
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی tetra-3d-final روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/tetra-3d-final
...
✓ Linked          ramin-edjlal-s-projects/tetra-3d-final

Retrieving project…
> Downloading `development` environment variables for ramin-edjlal-s-projects/tetra-3d-final
Downloading

✓ Created         .env.local file and added it to .gitignore
Deploying ramin-edjlal-s-projects/tetra-3d-final
Uploading [--------------------] (0.0B/3.8KB)
Uploading [====================] (3.8KB/3.8KB)
Error: Resource is limited - try again in 24 hours (more than 100, code: "api-deployments-free-per-day").](  🚀 دیپلوی tetra-3d-final روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
- **وضعیت:** ✅ فعال
- **آخرین به‌روزرسانی:** 2026-08-15 19:32
...
<!-- Trigger deploy: Mon Aug 17 01:49:29 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://tetra-3d-final.vercel.app](https://tetra-3d-final.vercel.app)
- **وضعیت:** ✅ فعال
